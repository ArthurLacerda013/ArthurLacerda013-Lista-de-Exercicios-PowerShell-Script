...
Sou **Jovem Aprendiz de Suporte Técnico de TI**, contratado pela **Petrobras**, e este repositório foi criado para registrar e compartilhar os exercícios propostos na disciplina de PowerShell.
A lista oficial está disponível no portal Moodle do professor:  
🔗 [Acessar lista completa](https://jussimarleal.com.br/moodle/mod/assign/view.php?id=112)
...
- **PowerShell**  
- **Windows** (ambiente de execução dos scripts)
